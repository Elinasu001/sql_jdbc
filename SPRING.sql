...
CREATE TABLE MEMBER (            
  ...
  USER_PWD VARCHAR2(100) NOT NULL,  -- pwd 암호화
...
INSERT INTO MEMBER
VALUES ('admin', '1234', '관리자', 'admin@kh.or.kr', 'F', 30, '010-1111-2222', '서울시 성동구 용답동', '20251001', '20251001', DEFAULT);

INSERT INTO MEMBER
VALUES ('user01', 'pass01', '홍길동', 'user01@kh.or.kr', 'M', 25, '010-3333-4444', '서울시 마포구 공덕동', '20251002', '20251002', DEFAULT);

INSERT INTO MEMBER
VALUES ('user02', 'pass02', '김말똥', 'user02@kh.or.kr', 'F', 23, '010-5555-6666', '서울시 영등포구 양평동', '20251003', '20251003', DEFAULT);
...
INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '관리자 공지', 'admin', '공지서비스를 게시합니다. 많이 이용해 주세요', '20251003');

INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '공지서비스 오픈 환영', 'admin', '드디어 오픈되었군요. 많이 이용하겠습니다.', '20251003');

INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '공지서비스 이용 안내', 'admin', '공지서비스는 회원만 이용할 수 있습니다. 회원 가입하세요.', '20251003');
...
INSERT INTO REPLY
VALUES (SEQ_RNO.NEXTVAL, '첫번째 댓글입니다.', 1, 'admin', '20251003', DEFAULT);

INSERT INTO REPLY
VALUES (SEQ_RNO.NEXTVAL, '첫번째 댓글입니다.', 13, 'user01', '20251003', DEFAULT);

INSERT INTO REPLY
VALUES (SEQ_RNO.NEXTVAL, '두번째 댓글입니다.', 13, 'user02', '20251003', DEFAULT);

INSERT INTO REPLY
VALUES (SEQ_RNO.NEXTVAL, '세번째 댓글입니다.', 13, 'admin', '20251003', DEFAULT);
...
SELECT * FROM FOOD_COMMENT WHERE SEQ = 102;
...
-- 컬럼 너무 많이 하지맙시다.
-- BOOT + RECT 개발용 테이블
-- 아이디, 비번, 닉네임, ROLE(인가/권한체크 - 관리자냐/일반사용자냐)
...
--------------------------------------------------------
-- refresh token을 담을 테이블 만들기
CREATE TABLE BOOT_TOKEN(
	TOKEN VARCHAR2(200) NOT NULL,
	MEMBER_ID VARCHAR2(20) REFERENCES BOOT_MEMBER,
	EXPIRATION NUMBER NOT NULL --밀리초로 넣기 위함
)
...
CREATE TABLE BOOT_BOARD(
	...
	BOARD_CONTENT VARCHAR2(4000) NOT NULL,
	BOARD_WRITER VARCHAR2(20) REFERENCES BOOT_MEMBER,
...
SELECT * FROM BOOT_MEMBER; -- ROLE

-- GENERATED BY DEFAULT 이걸 만들면 시퀀스 만들 필요 없음
-- 댓글 만들때 사용해보기 

CREATE SEQUENCE SEQ_BBN NOCACHE;


--------------------------------------------------------
--  댓글달기

CREATE TABLE BOOT_COMMENT(
	COMMENT_NO NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	COMMENT_WRITER VARCHAR2(20) NOT NULL REFERENCES BOOT_MEMBER,
	COMMENT_CONTENT VARCHAR2(3000) NOT NULL,
	CREATE_DATE DATE DEFAULT SYSDATE,
	COMMENT_STATUS CHAR(1) DEFAULT 'Y',
	REF_BOARD_NO NUMBER NOT NULL REFERENCES BOOT_BOARD
);
...
DROP TABLE BOOT_COMMENT;

--INSERT INTO BOOT_COMMENT(COMMENT_WRITER, COMMENT_CONTENT)
--VALUES()
