...
/*
	...
	* 권한 부여 (GRANT)
	- 시스템 권한 	 : 'DB에 접근'하는 권한, 객체를 생성할 수 있는 권한 ★
	- 객체 접근 권한 : '특정 객체'들에 접근해서 조작할 수 있는 권한
